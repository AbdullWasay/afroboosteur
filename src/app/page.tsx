...
import { adminSettingsService, homePageService, courseService } from '@/lib/database';
import { Course } from '@/types';
import WelcomePopup from '@/components/WelcomePopup';
import { isCoach } from '@/lib/roleUtils';
...
export default function Home() {
  ...
  return (
    <>
          ...
          <div className="content-spacing">
            ...
            >
              <motion.div variants={item} className="mb-6 md:mb-0">
                ...
                <p className="text-lg text-gray-300 mt-2">
                  {t('Check out our most popular dance courses')}
                </p>
              </motion.div>
              <motion.div variants={item}>
                <Link href="/courses" className="btn-primary flex items-center">
                  {t('View All Courses')} <FiArrowRight className="ml-2" />
                </Link>
              </motion.div>
            </motion.div>
              ...
              {courses.map((course) => (
                <motion.div key={course.id} variants={item}>
                  <Link href={`/courses/${course.id}`}>
                    <Card className="overflow-hidden h-full hover:border-[#D91CD2]/50 transition-all cursor-pointer">
                      <div className="relative h-44 mb-4">
                        <Image
                        ...
                        />
                        <div className="absolute top-2 right-2 bg-black/70 text-white text-xs px-2 py-1 rounded">
                          {course.difficulty || t('All Levels')}
                        </div>
                      </div>
                      ...
                      <div className="flex justify-between items-center">
                        <span className="text-[#D91CD2] font-bold">
                          {course.price} CHF
                        </span>
                        <span className="text-gray-400 text-xs">
                          {course.sessions} {t('sessions')}
                        </span>
                      </div>
                    </Card>
                  </Link>
      ...
      {/* Full Width CTA */}
      <section className="py-16 bg-gradient-to-r from-[#D91CD2] to-[#7000FF] relative overflow-hidden">
        {/* Decorative Elements */}
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-4">
              {t('Explore Our Dance Classes')}
            </h2>
            <p className="text-lg md:text-xl text-white/90 mb-8 max-w-2xl mx-auto">
              {t('Find the perfect class for your skill level and start your dance journey today')}
            </p>
            <Link
              href="/courses"
            ...
            >
              {t('View All Courses')} <FiArrowRight className="ml-2" size={24} />
            </Link>
          </motion.div>
        </div>
      </section>
