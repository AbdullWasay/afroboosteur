...
import { FiCalendar, FiUsers, FiPackage, FiSettings, FiDollarSign, FiCheckCircle, FiPercent, FiShare2, FiUser, FiSearch, FiFilter, FiTag } from 'react-icons/fi';
...
import CoachOffersPanel from '@/components/CoachOffersPanel';
      ...
      <div className="lg:col-span-1">
        <Card className="lg:sticky lg:top-24">
          ...
          <nav className="space-y-1 lg:space-y-2">
            ...
            >
              <FiTag className="mr-2 lg:mr-3" size={16} />
              <span className="hidden sm:inline lg:inline">{t('Offers')}</span>
              <span className="sm:hidden lg:hidden">{t('Offers')}</span>
            </button>
